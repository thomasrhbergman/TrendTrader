...
type
  TfrmCandidateAllFilters = class(TCustomForm)
    ...
    edtCandidateSettingPairs: TEdit;
    ...
    lblCandidateSettingPairs: TLabel;
...
{ TfrmCandidateAllFilters }

class function TfrmCandidateAllFilters.ShowDocument(aScanCriteria: PTIABScanCriteria): TModalResult;
var
  frmCandidateAllFilters: TfrmCandidateAllFilters;
begin
  frmCandidateAllFilters := TfrmCandidateAllFilters.Create(nil);
  try
    frmCandidateAllFilters.FScanCriteria := aScanCriteria^;
    frmCandidateAllFilters.Initialize;
    Result := frmCandidateAllFilters.ShowModal;
    if (Result = mrOk) then
    begin
      frmCandidateAllFilters.Denitialize;
      aScanCriteria^ := frmCandidateAllFilters.FScanCriteria;
    end;
  finally
    FreeAndNil(frmCandidateAllFilters);
  end;
end;

procedure TfrmCandidateAllFilters.Initialize;
begin
  ...
  edtCandidateSettingPairs.Text := FScanCriteria.CandidateSettingPairs;
...
procedure TfrmCandidateAllFilters.btnClearClick(Sender: TObject);
begin
  edtAbovePrice.Text                := '';
  edtBelowPrice.Text                := '';
  ...
  edtCandidateSettingPairs.Text       := '';
  edtSPRatingAbove.Text             := '';
  edtSPRatingBelow.Text             := '';
  edtStockTypeFilter.Text           := 'ALL';
end;

procedure TfrmCandidateAllFilters.Denitialize;
begin
  ...
  FScanCriteria.CandidateSettingPairs := '';
  ...
  if (edtCandidateSettingPairs.Text <> '') then
    FScanCriteria.CandidateSettingPairs := edtCandidateSettingPairs.Text;
...
procedure TfrmCandidateAllFilters.DoKeyPress(Sender: TObject; var Key: Char);
begin
