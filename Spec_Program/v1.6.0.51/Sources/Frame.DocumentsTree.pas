...
uses
  ...
  MessageDialog, Monitor.Types, DaImages, Edit.OrderGroup, Edit.Condition, Edit.Algos, Edit.OrderTemplate, Edit.Factor,
  Qualifiers.Types, Qualifiers.Edit, AutoTrades.Edit, Edit.OrderGroupSet, Vcl.ComCtrls, InformationDialog, Common.Types,
  VirtualTrees.ExportHelper, Monitor.Info, Qualifiers.EditCondition, System.Types, MonitorTree.Helper, MonitorTree.Document,
    ...
    begin
      ...
      case DocType1 of
        ...
        ntQualifierCondition:
          Result := CompareText(Data1^.QualifierCondition.Name, Data2^.QualifierCondition.Name);
        ntAutoTrade:
