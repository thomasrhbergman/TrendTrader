...
type
  ...
  public
    ...
    class function CreateQualifierCondition(const aParentNode: PVirtualNode; const aTree: TBaseVirtualTree): PVirtualNode; inline;
    ...
    class function GetQualifierItems(aNode: PVirtualNode): TArray<TQualifierCondition>; inline;
...
resourcestring
  ...
  C_SQL_DEL_QUALIFIER_CONDITION = 'DELETE FROM QUALIFIERS_CONDITION WHERE ID=:RecordId';
      ...
      begin
        ...
        case DocType of
          ...
          ntQualifierCondition:
            DeleteRow(C_SQL_DEL_QUALIFIER_CONDITION, RecordId);
          ntAutoTrade:
  ...
  begin
    ...
    begin
      ...
      case SourceData^.DocType of
        ...
        TDocType.ntQualifierCondition:
          begin
            Result := TTreeDocument.CreateQualifierCondition(aParentNode, aTree);
            NewData := Result^.GetData;
            NewData^.QualifierCondition.FromDB(SourceData^.RecordId);
            NewData^.QualifierCondition.OwnerNode := Result;
          end;
...
class function TTreeDocument.GetQualifierItems(aNode: PVirtualNode): TArray<TQualifierCondition>;
var
  CurrNode : PVirtualNode;
  Data: PTreeData;
begin
  ...
  begin
    ...
    begin
      ...
      begin
        Data^.QualifierCondition.OwnerNode := CurrNode;
        SetLength(Result, Length(Result) + 1);
        Result[High(Result)] := Data^.QualifierCondition;
      end;
      CurrNode := CurrNode.NextSibling;
    end;
  end;
...
begin
  ...
  begin
    ...
    case Data.DocType of
      ...
      ntQualifierCondition:
        Data.ImageNo := ICON_QUALIFIER_CONDITION;
      ntAutoTrade:
      ...
      begin
        ...
        if IsCreate then
          case DocType of
            ...
            TDocType.ntQualifierCondition:
              begin
                Node := TTreeDocument.CreateQualifierCondition(aParentNode, aTree);
                Data := Node^.GetData;
                Data^.QualifierCondition.FromDB(RecordId);
                Data^.QualifierCondition.OwnerNode := Node;
              end;
            TDocType.ntAutoTrade:
              begin
