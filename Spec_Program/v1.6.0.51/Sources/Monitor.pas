...
uses
  ...
  Scanner.Main, InformationDialog, Vcl.Printers, Edit.OrderBaseTransform, Order.Utils, Edit.OrderTemplate, VirtualTrees.Types,
...
begin
  ...
  begin
    ...
    Qualifier.DisableAllConditions;
...
begin
  TAction(Sender).Enabled := IABClient.Connected and
                             DMod.fbtAccounts.Active and
                             (DMod.fbtAccounts.FieldByName('QUALIFIERID').AsInteger > 0);
...
begin
  ...
  MarkedNode.RecordId := DMod.fbtAccounts.FieldByName('QUALIFIERID').AsInteger;
