...
type
  ...
  TDocType = (ntQualifier, ntQualifierCondition, ntAutoTrade, ntOrderGroupSet, ntOrderGroup, ntOrder, ntCondition, ntAlgos, ntFactor, ntUnknow);
  TDocTypes = set of TDocType;
  TDocTypeHelper = record helper for TDocType
  private
    const DocTypeString: array[TDocType] of string = ('Qualifier', 'QualifierCondition', 'AutoTrade', 'Order Groups', 'Order Group', 'Order', 'Condition', 'Algos', 'Factor', 'Unknow');
  public
    function ToString: string;
  end;
