inherited frameOrderStatus: TframeOrderStatus
  Width = 952
  Height = 374
  ExplicitWidth = 952
  ExplicitHeight = 374
  ...
  inherited vstTree: TVirtualStringTree
    ...
    OnDblClick = aShowOrderStatusDetailExecute
  ...
  object alOrderStatus: TActionList
    Left = 368
    Top = 96
    object aShowOrderStatusDetail: TAction
      Caption = 'Show Order Status Detail'
      ShortCut = 16467
      OnExecute = aShowOrderStatusDetailExecute
      OnUpdate = aShowOrderStatusDetailUpdate
    end
  end
  object pmOrderStatus: TPopupMenu
    Left = 192
    Top = 168
    object miShowOrderStatusDetail: TMenuItem
      Action = aShowOrderStatusDetail
    end
  end
