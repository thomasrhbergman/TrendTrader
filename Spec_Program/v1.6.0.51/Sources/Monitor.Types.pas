...
begin
  ...
  if Assigned(QualifierCondition) then
    FreeAndNil(QualifierCondition);
...
begin
  ...
  case aSource.DocType of
    ntQualifier:
      Self.Qualifier.AssignFrom(aSource.Qualifier, True);
    ntQualifierCondition:
      Self.QualifierCondition.AssignFrom(aSource.QualifierCondition);
    ntAutoTrade:
...
begin
  ...
  case Self.DocType of
    ...
    ntQualifierCondition:
      Result := Self.QualifierCondition.RecordId;
    ntAutoTrade:
...
begin
  ...
  case Self.DocType of
    ...
    ntQualifierCondition:
      if Assigned(Self.QualifierCondition) then
        Self.QualifierCondition.Enabled := FEnabled;
    ntAutoTrade:
...
begin
  case Self.DocType of
    ...
    ntQualifierCondition:
      Self.QualifierCondition.RecordId := Value;
    ntAutoTrade:
