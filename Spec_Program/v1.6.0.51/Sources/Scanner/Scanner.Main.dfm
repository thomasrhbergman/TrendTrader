object frmScannerMain: TfrmScannerMain
  Left = 0
  Top = 0
  ActiveControl = vstScanner
  Caption = 'Scan'
  ClientHeight = 649
  ClientWidth = 1039
  Color = clBtnFace
  ...
  object pnlMain: TPanel
    ...
    object pnlOptions: TPanel
      ...
      object btnSendDuplicateOrder: TBitBtn
        Left = 37
        Top = 0
        Width = 36
        Height = 36
        Action = aExecuteDuplicateOrder
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clGreen
        Font.Height = -16
        Font.Name = 'Tahoma'
      ...
      object pnlButtons: TPanel
        ...
        object btnSaveAutoTradeTemplateAs: TBitBtn
          Left = 72
          Top = 0
          Width = 36
          Height = 36
          Action = aSaveAutoTradeTemplateAs
          Align = alLeft
          Images = DMImage.vil32
          TabOrder = 1
        end
        object btnSaveAutoTradeTemplate: TBitBtn
          Left = 36
          Top = 0
          Width = 36
          Height = 36
          Action = aSaveAutoTradeTemplate
          Align = alLeft
          Images = DMImage.vil32
          TabOrder = 2
        end
        object btnOpenAutoTradeTemplate: TBitBtn
          Left = 0
          Top = 0
          Width = 36
          Height = 36
          ParentCustomHint = False
          Action = aOpenAutoTradeTemplate
          Align = alLeft
          Images = DMImage.vil32
          ParentShowHint = False
          ShowHint = True
    ...
    object pcScans: TPageControl
      ...
      Align = alClient
      TabOrder = 1
      object tsScans: TTabSheet
        Caption = 'Scans'
        object vstScanner: TVirtualStringTree
          Left = 0
          Top = 0
          Width = 834
          Height = 416
          ...
          OnAdvancedHeaderDraw = vstScannerAdvancedHeaderDraw
          OnBeforeCellPaint = vstScannerBeforeCellPaint
          OnCompareNodes = vstScannerCompareNodes
          OnDragAllowed = vstScannerDragAllowed
          OnDragOver = vstScannerDragOver
          OnDrawText = vstScannerDrawText
          OnFreeNode = vstScannerFreeNode
          OnGetText = vstScannerGetText
          OnPaintText = vstScannerPaintText
          OnGetHint = vstScannerGetHint
          OnHeaderDblClick = vstScannerHeaderDblClick
          OnHeaderDragging = vstScannerHeaderDragging
          OnHeaderDrawQueryElements = vstScannerHeaderDrawQueryElements
          OnHeaderMouseDown = vstScannerHeaderMouseDown
          OnInitNode = vstScannerInitNode
      ...
      object tsOrderGroups: TTabSheet
        Caption = 'Order Groups'
        ImageIndex = 1
        inline frameDocumentsTree: TframeDocumentsTree
          Left = 0
          Top = 0
          Width = 834
          Height = 499
