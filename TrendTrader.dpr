...
uses
  ...
  Edit.OrderDocument in 'Sources\Edit.OrderDocument.pas' {frmOrderBaseCustom},
  ...
  Qualifiers.Edit in 'Sources\Qualifiers\Qualifiers.Edit.pas' {frmQualifierEdit},
  ...
  Vcl.Themes,
  Vcl.Styles,
  ListForm in 'Sources\ListForm.pas' {frmListForm},
  Candidate.AllFilters in 'Sources\Candidates\Candidate.AllFilters.pas' {frmCandidateAllFilters},
  Candidate.DragDropOptions in 'Sources\Candidates\Candidate.DragDropOptions.pas' {frmCandidateDragDropOptions},
  Candidate.EditWeight in 'Sources\Candidates\Candidate.EditWeight.pas' {frmCandidateEditWeight},
  Candidate.EmbargoColumn in 'Sources\Candidates\Candidate.EmbargoColumn.pas' {frmCandidateEmbargoColumn},
  Candidate.FilterList in 'Sources\Candidates\Candidate.FilterList.pas' {frmCandidateFilterList},
  Candidate.Filters in 'Sources\Candidates\Candidate.Filters.pas',
  Candidate.GradientColumn in 'Sources\Candidates\Candidate.GradientColumn.pas' {frmCandidateGradientColumn},
  Candidate.Main in 'Sources\Candidates\Candidate.Main.pas' {frmCandidateMain},
  Candidate.Market in 'Sources\Candidates\Candidate.Market.pas' {frmCandidateMarket},
  Candidate.MarketOpenSequence in 'Sources\Candidates\Candidate.MarketOpenSequence.pas' {frmCandidateMarketOpenSequence},
  Candidate.OpenGroup in 'Sources\Candidates\Candidate.OpenGroup.pas' {frmCandidateOpenGroup},
  Candidate.StaticList in 'Sources\Candidates\Candidate.StaticList.pas' {frmCandidateStaticList},
  Candidate.StaticLists in 'Sources\Candidates\Candidate.StaticLists.pas' {frmCandidateStaticLists},
  Candidate.TickColumn in 'Sources\Candidates\Candidate.TickColumn.pas' {frmCandidateTickColumn},
  Candidate.Types in 'Sources\Candidates\Candidate.Types.pas',
